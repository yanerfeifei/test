...
/**
 * @Auther: Alisa.Xie
 * @Date: 2018年05月08日  11:03:15
 * @Description:
 */
public class TimeChange {
   /* public static void main(String[] args) {
        try {
            calculateTimeDifferenceByCalendar("2017/05/07");
        }catch (Exception e){
            e.printStackTrace();
        }
    }*/
    ...
    /*public static void main(String[] args) {
        calculateTimeDifferenceByPeriod(2018,Month.JANUARY,6);
    }*/
    /**
     * 使用java 8的Period的对象计算两个LocalDate对象的时间差，严格按照年、月、日计算，
     * 如：2018-03-12 与 2014-05-23 相差 3 年 9 个月 17 天
     * @param year
     * @param month
     * @param dayOfMonth
     */
